...
> ⚠️ **A note on authorship**: All projects listed here (except philosophers and the cybersecurity interest) are **group work**. The code, analyses, and deliverables are the result of collective collaboration. I do not claim sole ownership over any of these works, I present them solely as evidence of my active participation and the skills I developed in an academic context.
...
- Getting the Security + Certification
